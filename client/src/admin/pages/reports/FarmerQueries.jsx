import { useGetAllQueries } from '@/admin/hooks/reports.hooks'
  ...
  return (
    <div className='p-6 min-h-screen bg-background'>
      <header className='mb-6'>
        <h1 className='text-2xl font-bold text-foreground'>Farmer Help Desk</h1>
        <p className='text-muted-foreground text-sm'>
          Review and help farmers with their questions
        </p>
      </header>
        ...
        {isLoading ? (
          ...
          <div className='flex flex-col items-center justify-center py-20 bg-card border border-dashed border-border rounded-xl'>
            <p className='text-muted-foreground font-medium text-sm'>
              No new questions from farmers today.
            </p>
          </div>
        ) : (
          queries.map(item => (
            ...
            >
              ...
              <div className='flex items-center gap-2 text-muted-foreground mt-1'>
                ...
                <p className='text-sm line-clamp-1'>{item.message}</p>
              </div>
