...
import { registerFarmerSchema, loginFarmerUsingOtpSchema, loginFarmerWithPasswordSchema, forgotPasswordSchema, changePasswordSchema, changeFarmerDataSchema, changeEmailSchema } from '../validator/farmer.validator.js'
import { register, loginFarmerUsingOtp, loginFarmerUsingPassword, forgotPassword, logoutFarmer, currentUser, changePassword, toggleIsContactVisible, changeFarmerData, farmerDashboard, changeEmail } from '../controllers/farmer.controller.js'
...
farmerRoutes.put("/change/email", updateApiLimiter, authLayer, changeDataLimiter, activeFarmer, validate(changeEmailSchema), changeEmail)
